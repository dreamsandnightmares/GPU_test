...
def main():
    ...
    # # print(Boundary)
    Boundary = np.array([[3500.,2900,900,9000],[1000.,300.,100,1000]])
    print(type(Boundary))
    ''
    # Boundary =
    max_ = Boundary[0]
    ...
    para = {'pv_cost:': cost_pv, 'el_cost:': cost_el,'fc_cost':cost_fc,'cost_ht':cost_ht,'Boundary:': Boundary,'el_eff':0.75,'fc_eff':0.6}
