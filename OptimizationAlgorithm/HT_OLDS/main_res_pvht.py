...
def main():
    ...
    # # print(Boundary)
    Boundary = np.array([[1500.,2000,1000,2000],[300.,300.,300,500]])
    print(type(Boundary))
    ''
    # Boundary =
    max_ = Boundary[0]
    ...
    with open("pareto_in_ht_olds.txt", "w") as f:
        pass
    file_path = os.path.abspath("pareto_in_ht_olds.txt")

    with open("pareto_fitness_ht_olds.txt", "w") as f:
        pass
    file_path_fitness = os.path.abspath("pareto_fitness_ht_olds.txt")
