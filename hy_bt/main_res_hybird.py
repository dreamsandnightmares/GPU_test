...
def main():
    ...
    # # print(Boundary)
    Boundary = np.array([[3500., 3000, 3000., 100, 9000], [700., 300, 200., 200, 1000]])
    print(type(Boundary))
    ''
    # Boundary =
    max_ = Boundary[0]
    ...
    with open("pareto_in_hy_2030_pem.txt", "w") as f:
        pass
    file_path = os.path.abspath("pareto_in_hy_2030_pem.txt")

    with open("pareto_fitness_hy_2030_pem.txt", "w") as f:
        pass
    file_path_fitness = os.path.abspath("pareto_fitness_hy_2030_pem.txt")
